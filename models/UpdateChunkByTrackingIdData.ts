 ...
 */
export function instanceOfUpdateChunkByTrackingIdData(value: object): boolean {
    if (!('trackingId' in value)) return false;
    return true;
}

export function UpdateChunkByTrackingIdDataFromJSON(json: any): UpdateChunkByTrackingIdData {
    return UpdateChunkByTrackingIdDataFromJSONTyped(json, false);
}

export function UpdateChunkByTrackingIdDataFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdateChunkByTrackingIdData {
    if (json == null) {
        return json;
    }
    return {
...
export function UpdateChunkByTrackingIdDataToJSON(value?: UpdateChunkByTrackingIdData | null): any {
    if (value == null) {
        return value;
    }
    return {
