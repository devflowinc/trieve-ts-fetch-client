 ...
 */
export declare function instanceOfRegenerateMessageData(value: object): boolean;
export declare function RegenerateMessageDataFromJSON(json: any): RegenerateMessageData;
export declare function RegenerateMessageDataFromJSONTyped(json: any, ignoreDiscriminator: boolean): RegenerateMessageData;
export declare function RegenerateMessageDataToJSON(value?: RegenerateMessageData | null): any;
