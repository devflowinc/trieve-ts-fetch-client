 ...
 */
export declare function instanceOfUpdateChunkData(value: object): boolean;
export declare function UpdateChunkDataFromJSON(json: any): UpdateChunkData;
export declare function UpdateChunkDataFromJSONTyped(json: any, ignoreDiscriminator: boolean): UpdateChunkData;
export declare function UpdateChunkDataToJSON(value?: UpdateChunkData | null): any;
