 ...
 */
export declare function instanceOfCreateChunkGroupData(value: object): boolean;
export declare function CreateChunkGroupDataFromJSON(json: any): CreateChunkGroupData;
export declare function CreateChunkGroupDataFromJSONTyped(json: any, ignoreDiscriminator: boolean): CreateChunkGroupData;
export declare function CreateChunkGroupDataToJSON(value?: CreateChunkGroupData | null): any;
