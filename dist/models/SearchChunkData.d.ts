 ...
 */
export declare function instanceOfSearchChunkData(value: object): boolean;
export declare function SearchChunkDataFromJSON(json: any): SearchChunkData;
export declare function SearchChunkDataFromJSONTyped(json: any, ignoreDiscriminator: boolean): SearchChunkData;
export declare function SearchChunkDataToJSON(value?: SearchChunkData | null): any;
