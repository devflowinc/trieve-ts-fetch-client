...
exports.SearchChunkDataToJSON = exports.SearchChunkDataFromJSONTyped = exports.SearchChunkDataFromJSON = exports.instanceOfSearchChunkData = void 0;
var ChunkFilter_1 = require("./ChunkFilter");
/**
 * Check if a given object implements the SearchChunkData interface.
 */
function instanceOfSearchChunkData(value) {
    if (!('query' in value))
        return false;
...
exports.instanceOfSearchChunkData = instanceOfSearchChunkData;
function SearchChunkDataFromJSON(json) {
    return SearchChunkDataFromJSONTyped(json, false);
}
exports.SearchChunkDataFromJSON = SearchChunkDataFromJSON;
function SearchChunkDataFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
exports.SearchChunkDataFromJSONTyped = SearchChunkDataFromJSONTyped;
function SearchChunkDataToJSON(value) {
    if (value == null) {
        return value;
    }
    return {
...
exports.SearchChunkDataToJSON = SearchChunkDataToJSON;
