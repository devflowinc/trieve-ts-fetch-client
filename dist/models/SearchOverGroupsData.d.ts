 ...
 */
export declare function instanceOfSearchOverGroupsData(value: object): boolean;
export declare function SearchOverGroupsDataFromJSON(json: any): SearchOverGroupsData;
export declare function SearchOverGroupsDataFromJSONTyped(json: any, ignoreDiscriminator: boolean): SearchOverGroupsData;
export declare function SearchOverGroupsDataToJSON(value?: SearchOverGroupsData | null): any;
