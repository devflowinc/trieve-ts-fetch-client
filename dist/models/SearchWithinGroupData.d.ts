 ...
 */
export declare function instanceOfSearchWithinGroupData(value: object): boolean;
export declare function SearchWithinGroupDataFromJSON(json: any): SearchWithinGroupData;
export declare function SearchWithinGroupDataFromJSONTyped(json: any, ignoreDiscriminator: boolean): SearchWithinGroupData;
export declare function SearchWithinGroupDataToJSON(value?: SearchWithinGroupData | null): any;
