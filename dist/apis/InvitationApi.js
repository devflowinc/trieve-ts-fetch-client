...
var InvitationApi = /** @class */ (function (_super) {
     ...
     * Send Invitation
     */
    InvitationApi.prototype.postInvitationRaw = function (requestParameters, initOverrides) {
                ...
                switch (_c.label) {
                    case 0:
                        if (requestParameters['tROrganization'] == null) {
                            throw new runtime.RequiredError('tROrganization', 'Required parameter "tROrganization" was null or undefined when calling postInvitation().');
                        }
                        if (requestParameters['invitationData'] == null) {
                            throw new runtime.RequiredError('invitationData', 'Required parameter "invitationData" was null or undefined when calling postInvitation().');
                        }
                        queryParameters = {};
                        headerParameters = {};
                    ...
                    case 2: return [4 /*yield*/, this.request({
                            ...
                            body: (0, index_1.InvitationDataToJSON)(requestParameters['invitationData']),
                        }, initOverrides)];
                    case 3:
                        response = _c.sent();
     ...
     * Send Invitation
     */
    InvitationApi.prototype.postInvitation = function (requestParameters, initOverrides) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.postInvitationRaw(requestParameters, initOverrides)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
